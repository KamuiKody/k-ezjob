...
Imports.Items = { -- this will add the items to the items.lua
    ...
    ['bcoffee'] 				    = {['name'] = 'bcoffee', 			  	  	['label'] = 'B Coffee', 				['weight'] = 200, 		['type'] = 'item', 		['image'] = 'bcoffee.png', 				    ['unique'] = true, 	['useable'] = true, 	['shouldClose'] = true,	 ["degrade"] = 10.0, ['trade'] = 'bad_drink',     ['combinable'] = nil,   ['description'] = 'Pump 4 Caffeine'},
